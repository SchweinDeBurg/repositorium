...
# Usage for Microsoft:
#     nmake -f ScintillaVC.mak
# For debug versions define DEBUG on the command line:
#     nmake DEBUG=1 -f ScintillaVC.mak
...
CXXDEBUG=-Od -Ob1 -GL- -MDd -DSCI_NAMESPACE -DDEBUG
CXXNDEBUG=-O1 -GL- -MD -DSCI_NAMESPACE -DNDEBUG
NAME=-Fo
...
clean:
	-del /q $(DIR_O)\*.obj $(DIR_O)\*.pdb $(DIR_O)\BuildLog.htm $(COMPONENT) $(LEXCOMPONENT) \
	$(DIR_O)\*.res $(DIR_BIN)\*.map $(DIR_BIN)\*.manifest $(DIR_BIN)\*.pdb $(DIR_LIB)\*.lib \
	$(DIR_LIB)\*.exp
