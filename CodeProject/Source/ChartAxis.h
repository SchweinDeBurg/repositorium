...
public:
	...
	void	 SetAxisType(AxisType Type)  { m_AxisType = Type; }
	...
	void SetDateTimeFormat(bool bAutomatic, std::string strFormat)
	{
...
private:
	...
	std::string m_strDTTickFormat;		// Format of the date/time tick labels
