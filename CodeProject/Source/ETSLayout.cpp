...
#if defined(CS_HELP)
IMPLEMENT_DYNAMIC(ETSLayoutDialog, ETSCSHelpDialog)
#else
IMPLEMENT_DYNAMIC(ETSLayoutDialog, CDialog)
#endif	// CS_HELP
...
/////////////////////////////////////////////////////////////////////////////
// ETSLayoutDialogBar dialog

#if defined(CS_HELP)
IMPLEMENT_DYNAMIC(ETSLayoutDialogBar, ETSCSHelpDlgBar)
#else
IMPLEMENT_DYNAMIC(ETSLayoutDialogBar, CDialogBar)
#endif	// CS_HELP
...
void ETSLayoutPropertySheet::OnGetMinMaxInfo(MINMAXINFO FAR* lpMMI) 
{
	if(m_RootPane.IsValid() && GetTabControl() != 0 ) 
	{
		...
		lpMMI->ptMinTrackSize.x = max(lpMMI->ptMinTrackSize.x, static_cast<LONG>(m_rcStart.Width()));
		lpMMI->ptMinTrackSize.y = max(lpMMI->ptMinTrackSize.y, static_cast<LONG>(m_rcStart.Height()));
