...
#ifdef EXPAT_LIB_BUILD /* we are building the Expat library itself */

/* Prevention of the automatic CRT/MFC dependencies generation.
   ...
   by Martin Richter for more information.
*/

#if defined(_MSC_VER) && (_MSC_VER >= 1400) && !defined(UNDER_CE)
/* We are using VC++ 2005 (8.0) or greater. */
