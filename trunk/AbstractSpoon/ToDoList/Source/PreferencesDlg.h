...
public:
	...
	BOOL GetAutoExport() const { return m_pageFile.GetAutoExport(); }
	BOOL GetExportToHTML() const { return m_pageFile.GetExportToHTML(); }
	int GetOtherExporter() const { return m_pageFile.GetOtherExporter(); }
	...
	double GetDefaultTimeSpent(int& nUnits) const { return m_pageTaskDef.GetDefaultTimeSpent(nUnits); }
	...
	BOOL GetDueTasksHaveHighestPriority() const { return m_pageTask.GetDueTasksHaveHighestPriority(); }
	BOOL GetDoneTasksHaveLowestPriority() const { return m_pageTask.GetDoneTasksHaveLowestPriority(); }
	BOOL GetDoneTasksHaveLowestRisk() const { return m_pageTask.GetDoneTasksHaveLowestRisk(); } 
	...
	BOOL GetNoDueDateIsDueToday() const { return m_pageTask.GetNoDueDateIsDueToday(); }
