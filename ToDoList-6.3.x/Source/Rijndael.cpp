...
int Rijndael::init(Mode mode, Direction dir, const RD_UINT8* key, KeyLength keyLen, RD_UINT8* initVector)
{
	...
	for (RD_UINT32 i = 0; i < uKeyLenInBytes; i++)
	{
...
#else
			*((RD_UINT32*)iv[0]) = ((RD_UINT32*)input)[0];
			((RD_UINT32*)outBuffer)[0] = ((RD_UINT32*)block)[0];
			*((RD_UINT32*)iv[1]) = ((RD_UINT32*)input)[1];
			((RD_UINT32*)outBuffer)[1] = ((RD_UINT32*)block)[1];
			*((RD_UINT32*)iv[2]) = ((RD_UINT32*)input)[2];
			((RD_UINT32*)outBuffer)[2] = ((RD_UINT32*)block)[2];
			*((RD_UINT32*)iv[3]) = ((RD_UINT32*)input)[3];
			((RD_UINT32*)outBuffer)[3] = ((RD_UINT32*)block)[3];
#endif
			input += 16;
			outBuffer += 16;
		}
