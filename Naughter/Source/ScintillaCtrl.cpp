...
int CScintillaCtrl::GetStyledText(Scintilla::TextRange* tr, BOOL bDirect)
{
...
long CScintillaCtrl::FindText(int flags, Scintilla::TextToFind* ft, BOOL bDirect)
{
  return Call(SCI_FINDTEXT, static_cast<WPARAM>(flags), reinterpret_cast<LPARAM>(ft), bDirect);
}

long CScintillaCtrl::FormatRange(BOOL draw, Scintilla::RangeToFormat* fr, BOOL bDirect)
{
...
int CScintillaCtrl::GetTextRange(Scintilla::TextRange* tr, BOOL bDirect)
{
