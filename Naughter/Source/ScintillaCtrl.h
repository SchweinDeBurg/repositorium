...
//Auto generated using the "ConvertScintillaiface.js" script
  ...
  int GetStyledText(Scintilla::TextRange* tr, BOOL bDirect = TRUE);
  ...
  long FindText(int flags, Scintilla::TextToFind* ft, BOOL bDirect = TRUE);
  long FormatRange(BOOL draw, Scintilla::RangeToFormat* fr, BOOL bDirect = TRUE);
  ...
  int GetTextRange(Scintilla::TextRange* tr, BOOL bDirect = TRUE);
