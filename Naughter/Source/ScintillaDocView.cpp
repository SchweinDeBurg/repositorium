...
#include <afxdisp.h>
#endif
#include "ScintillaWrappersRes.h"
...
void CScintillaView::PrintHeader(CDC* pDC, CPrintInfo* /*pInfo*/, Scintilla::RangeToFormat& frPrint)
{
...
void CScintillaView::PrintFooter(CDC* pDC, CPrintInfo* pInfo, Scintilla::RangeToFormat& frPrint)
{
...
long CScintillaView::PrintPage(CDC* pDC, CPrintInfo* pInfo, long nIndexStart, long nIndexStop)
{
  //Validate our parameters
	...
	Scintilla::RangeToFormat rfPrint;
...
long CScintillaView::FindAndSelect(DWORD dwFlags, Scintilla::TextToFind& ft)
{
  CScintillaCtrl& rCtrl = GetCtrl();
...
void CScintillaView::OnStyleNeeded(Scintilla::SCNotification* /*pSCNotification*/)
{
  //By default do nothing, derived classes may want to do something
}

void CScintillaView::OnCharAdded(Scintilla::SCNotification* /*pSCNotification*/)
{
  //By default do nothing, derived classes may want to do something
}

void CScintillaView::OnSavePointReached(Scintilla::SCNotification* /*pSCNotification*/)
{
  //By default do nothing, derived classes may want to do something
}

void CScintillaView::OnSavePointLeft(Scintilla::SCNotification* /*pSCNotification*/)
{
  //By default do nothing, derived classes may want to do something
}

void CScintillaView::OnModifyAttemptRO(Scintilla::SCNotification* /*pSCNotification*/)
{
  //By default do nothing, derived classes may want to do something
}

void CScintillaView::OnDoubleClick(Scintilla::SCNotification* /*pSCNotification*/)
{
  //By default do nothing, derived classes may want to do something
}

void CScintillaView::OnUpdateUI(Scintilla::SCNotification* /*pSCNotification*/)
{
  //By default do nothing, derived classes may want to do something
}

void CScintillaView::OnModified(Scintilla::SCNotification* /*pSCNotification*/)
{
  //By default do nothing, derived classes may want to do something
}

void CScintillaView::OnMacroRecord(Scintilla::SCNotification* /*pSCNotification*/)
{
  //By default do nothing, derived classes may want to do something
}

void CScintillaView::OnMarginClick(Scintilla::SCNotification* pSCNotification)
{
...
void CScintillaView::OnNeedShown(Scintilla::SCNotification* /*pSCNotification*/)
{
  //By default do nothing, derived classes may want to do something
}

void CScintillaView::OnPainted(Scintilla::SCNotification* /*pSCNotification*/)
{
  //By default do nothing, derived classes may want to do something
}

void CScintillaView::OnUserListSelection(Scintilla::SCNotification* /*pSCNotification*/)
{
  //By default do nothing, derived classes may want to do something
}

void CScintillaView::OnDwellStart(Scintilla::SCNotification* /*pSCNotification*/)
{
  //By default do nothing, derived classes may want to do something
}

void CScintillaView::OnDwellEnd(Scintilla::SCNotification* /*pSCNotification*/)
{
  //By default do nothing, derived classes may want to do something
}

void CScintillaView::OnZoom(Scintilla::SCNotification* /*pSCNotification*/)
{
  //By default do nothing, derived classes may want to do something
}

void CScintillaView::OnHotSpotClick(Scintilla::SCNotification* /*pSCNotification*/)
{
  //By default do nothing, derived classes may want to do something
}

void CScintillaView::OnHotSpotDoubleClick(Scintilla::SCNotification* /*pSCNotification*/)
{
  //By default do nothing, derived classes may want to do something
}

void CScintillaView::OnCallTipClick(Scintilla::SCNotification* /*pSCNotification*/)
{
  //By default do nothing, derived classes may want to do something
}

void CScintillaView::OnAutoCSelection(Scintilla::SCNotification* /*pSCNotification*/)
{
  //By default do nothing, derived classes may want to do something
}
...
BOOL CScintillaView::OnNotify(WPARAM wParam, LPARAM lParam, LRESULT* pResult)
{
  ...
  {
    Scintilla::SCNotification* pSCNotification = reinterpret_cast<Scintilla::SCNotification*>(lParam);
    switch (pNMHdr->code)
    {
